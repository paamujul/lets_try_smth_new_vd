        ...
        return (
            <div className="flex flex-col items-center justify-center h-full p-6 text-center">
                <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="max-w-2xl w-full space-y-6 bg-white p-8 shadow-2xl rotate-1">
                    <h2 className="text-5xl md:text-8xl font-paint text-green-600">YAY! 💖</h2>
                    <p className="text-3xl md:text-4xl font-hand text-black">Add me on Snap:</p>
                    <p className="text-3xl md:text-5xl font-mono font-bold text-white bg-black p-4 inline-block -rotate-2 break-all">sgp0004</p>
                    <p className="text-3xl md:text-4xl font-hand text-black">no snap? dw, here is my email:</p>
                    <p className="text-xl md:text-5xl font-mono font-bold text-white bg-black p-4 inline-block -rotate-2 break-all max-w-full">socialssgp@gmail.com</p>
                </motion.div>
            </div>
        );
    }
